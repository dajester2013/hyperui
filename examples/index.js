...
import AutoElementComponent from "../esm/widgets/component/AutoElementComponent";

window.c = Container.attach(document.body);

window.List = List;
window.AutoElementComponent = AutoElementComponent;
